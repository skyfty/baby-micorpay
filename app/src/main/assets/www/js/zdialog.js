...
;(function($,window,document,undefined){
		   //默认参数
		    ...
		    function Show(params, caller){
		        if ($.DialogByZ.state) return;
		    	  Init(params);
		    	  $.DialogByZ.state = true;
		    	  var dislogContainer;
		    	  var dialogInner;
		    	  var dialogBtn;
		    	  var blackFilter=$('<div class="zbox-popup-backdrop" style="display: block;"></div>');
		    	  if(caller=='Autofade'){
		    	  	...
		    	  	dialogBtn=$('<div class="zbox-popup-buttons"><span class="zbox-popup-button" index_key="27" index="1">'+PARAMS.BtnR+'</span></div>');
		    	  	if(caller=='Confirm'){
		    	  		dialogBtn.append($('<span class="zbox-popup-button R"  index_key="13" index="0">'+PARAMS.BtnL+'</span>'));
		    	  	}
